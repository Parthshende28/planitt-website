...
export const metadata: Metadata = {
  title: "Planitt Wealth Advisory | Planitt",
  description: "On-site mutual fund recommendation assistant powered strictly by the provided dataset.",
};
