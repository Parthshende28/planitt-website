...
import { HelpCircle, Maximize2, Minimize2, Sparkles, X } from "lucide-react";
import TechnicalFaqChatClient from "@/components/TechnicalFaqChatClient";
import { useHomeMode } from "@/context/HomeModeContext";
import { shouldShowTechnicalFaqBot } from "@/lib/serviceBots";

export default function TechnicalFaqFab() {
