                ...
                <motion.div className="w-full mb-6">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-2 shadow-sm border border-gray-100 dark:border-gray-700 flex transition-colors duration-300">
                        <button
                            ...
                            className={`flex-1 py-3 px-4 text-center rounded-lg font-medium transition-all duration-200 ${active === 'financial' ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
                        >
                            Financial Services
                        </button>
                        <button
                            onClick={() => setActive((s) => (s === 'technical' ? 'none' : 'technical'))}
                            className={`flex-1 py-3 px-4 text-center rounded-lg font-medium transition-all duration-200 ${active === 'technical' ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
                        >
                            Technical Services
                        </button>
                    </div>
                                    ...
                                    >
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="pt-4 flex justify-end">
                                                <ArrowRight className={`h-5 w-5 ${service.textColor} dark:text-blue-400 group-hover:translate-x-1 transition-transform duration-200`} />
                                            </div>
                                        </div>
                                    </a>
                                </motion.div>
